...
export async function POST(request: NextRequest) {
  try {
    ...
    const rateCheck = await checkRateLimit(`student-signup:${ip}`, RATE_LIMITS.AUTH);
    ...
    // Invalidate all caches so dashboards reflect the new student
    ...
    try {
      ...
      console.error("[student-signup] Cache invalidation failed (non-fatal):", cacheError);
    }
